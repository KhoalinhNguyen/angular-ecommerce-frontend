...
function sendToLoginPage(oktaAuth: OktaAuth, injector: Injector) {
  // User injector to access any service available within my application
...
@NgModule({
  ...
  providers: [ProductService, { provide: OKTA_CONFIG, useValue: {oktaAuth}}], // service in provider will be able to be injected by other components
